...
# 적 enemy 캐릭터
enemy = pygame.image.load(r'img\enemy.png')
enemy_size = enemy.get_rect().size # 이미지의 크기를 구해옴
enemy_width = enemy_size[0] # 캐릭터의 가로 크기
enemy_height = enemy_size[1] # 캐릭터의 세로 크기
enemy_x_pos = (screen_width / 2) - (enemy_width / 2) # 화면 가운데
enemy_y_pos = (screen_height / 2) - (enemy_height / 2) # 화면 세로 크기 가장 아래에 두기
...
while running:
    ...
    # 경과 시간(밀리세컨드)를 1000으로 나누어서 초로 변환
